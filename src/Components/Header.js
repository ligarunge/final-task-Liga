                    ...
                    <ul className="nav justify-content-center">
                        <li className="nav-item">
                            <Link className="nav-link text-white" to="/">
                                <img src="/images/bookSeaBlue.png" className="img-fluid rounded-circle" style={{ height: '6rem' }} alt="logo" />
                            </Link>
                        </li>
                        ...
                        <li className="nav-item dropdown mt-4">
                            <Link className="nav-link dropdown-toggle text-white pb-0" style={{fontSize:'1.1rem', textShadow: '2px 2px 4px #000000'}} to="/categories" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Categories
                            </Link>
