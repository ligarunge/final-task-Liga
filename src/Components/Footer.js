                    ...
                    <div className="row text-center">
                        <div className="col-12">
                            <button className="btn btn-outline-light m-3">
                                <Link to="/register" className="link-white font-baskerville">Join us</Link>
                            </button>
                        </div>
                    </div>
                    <div className="row justify-content-center text-white">
                        <div className="col-12 pb-4 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-pinterest m-2" viewBox="0 0 16 16">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-google m-2" viewBox="0 0 16 16">
                    ...
                    <div className="row">
                        <div className="col-md-3">
                            <Link className="nav-link text-white" to="/">
                                <img src="/images/bookSeaBlue.png" className="img-fluid rounded-circle m-2 ms-5" style={{ height: '10rem' }} alt="logo" />
                            </Link>
                        </div>
