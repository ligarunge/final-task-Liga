...
function Categories() {
    ...
    const categoriesList = categories.map((category, index) => {
        return (
            <div className="row pt-5 justify-content-center" key={index}>
                ...
                <div className="col-md-7 mt-5 pt-5 rounded" style={{backgroundColor:'whitesmoke'}}>
                    ...
                    <div className="row m-4">
                        ...
                        <div className="col-md-2 p-0">
                        <img src={category.img3} className="img-fluid rounded" style={{height: '13rem'}} alt="cover" />
                        </div>
                        <div className="col-md-2 p-0">
                        <img src={category.img4} className="img-fluid rounded" style={{height: '13rem'}} alt="cover" />
                        </div>
                        <div className="col-md-2 p-0">
                        <img src={category.img5} className="img-fluid rounded" style={{height: '13rem'}} alt="cover" />
                        </div>
                        <div className="col-md-2 p-0">
                        <img src={category.img6} className="img-fluid rounded" style={{height: '13rem'}} alt="cover" />
                        </div>
